    ...
    public function registerClient(Request $request)
{
    $request->validate([
        ...
        'password' => 'required|min:6|confirmed', // La règle 'confirmed' vérifie que 'password_confirmation' est identique
    ]);
